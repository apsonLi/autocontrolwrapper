...
def is_notice(data):
    ...
    while n < 3:
        if "请查看大图" in data or "区" not in data:
            time.sleep(2)
            devices.AdbShellInputTap(1361, 89)
            time.sleep(2)
...
def rule():
    ...
    # time.sleep(100)
    # devices.AdbShellInputTap(528, 589)
    # time.sleep(2)
    # devices.adbDumpTap("游客登录", apkPath)
    # time.sleep(5)
    # devices.AdbShellInputTap(1080, 225)
    # time.sleep(2)
    # devices.AdbShellInputTap(1361, 89)
    # time.sleep(2)
    # devices.AdbShellScreencapPullRm(picture)
    ...
    # if "正在" in data:
    #     time.sleep(2)
    #     devices.AdbShellInputTap(777, 668)
    #     time.sleep(2)
    #     devices.AdbShellInputTap(528, 589)
    #     time.sleep(2)
    #     devices.adbDumpTap("游客登录", apkPath)
    ...
    # time.sleep(5)
    # devices.AdbShellInputTap(1327, 94)
    # time.sleep(2)
    # devices.AdbShellScreencapPullRm(picture)
    # time.sleep(2)
    # qfvalue = OCRbase(picture, isFix=True, topX=1007, bottomX=1333, topY=447, bottomY=503)
    ...
    devices.start_apk(apkPath)
    time.sleep(15)
    devices.AdbShellInputTap(636, 701)
    time.sleep(100)
    devices.AdbShellInputTap(558, 706)
    time.sleep(2)
    ...
    time.sleep(2)
    devices.AdbShellInputTap(658, 436)
    time.sleep(2)
